...
func (s *loggingNewrelic) CreateLogNewrelic(ctx context.Context, request operations.CreateLogNewrelicRequest) (*operations.CreateLogNewrelicResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, true, "LoggingNewrelic3", "form", `request:"mediaType=application/x-www-form-urlencoded"`)
	if err != nil {
