...
func (s *loggingSplunk) CreateLogSplunk(ctx context.Context, request operations.CreateLogSplunkRequest) (*operations.CreateLogSplunkResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, true, "LoggingSplunk2", "form", `request:"mediaType=application/x-www-form-urlencoded"`)
	if err != nil {
