...
func (s *tlsActivations) CreateTLSActivation(ctx context.Context, request *shared.TLSActivationInput) (*operations.CreateTLSActivationResponse, error) {
...
func (s *tlsActivations) UpdateTLSActivation(ctx context.Context, request operations.UpdateTLSActivationRequest) (*operations.UpdateTLSActivationResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, true, "TLSActivationInput", "json", `request:"mediaType=application/vnd.api+json"`)
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
