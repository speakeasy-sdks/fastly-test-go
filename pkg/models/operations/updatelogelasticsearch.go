...
type UpdateLogElasticsearchRequest struct {
	LoggingElasticsearch *shared.LoggingElasticsearch `request:"mediaType=application/x-www-form-urlencoded"`
...
func (o *UpdateLogElasticsearchRequest) GetLoggingElasticsearch() *shared.LoggingElasticsearch {
	if o == nil {
		return nil
	}
