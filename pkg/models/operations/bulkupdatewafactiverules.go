...
type BulkUpdateWafActiveRulesRequest struct {
	BulkWafActiveRule *shared.BulkWafActiveRule `request:"mediaType=application/vnd.api+json"`
...
func (o *BulkUpdateWafActiveRulesRequest) GetBulkWafActiveRule() *shared.BulkWafActiveRule {
	if o == nil {
		return nil
	}
