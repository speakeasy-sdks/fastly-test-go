...
type CreateLogSplunkRequest struct {
	LoggingSplunk *shared.LoggingSplunk `request:"mediaType=application/x-www-form-urlencoded"`
...
func (o *CreateLogSplunkRequest) GetLoggingSplunk() *shared.LoggingSplunk {
	if o == nil {
		return nil
	}
