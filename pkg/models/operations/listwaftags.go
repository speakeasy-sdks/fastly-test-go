...
type ListWafTagsRequest struct {
	...
	include *string `const:"waf_rules" queryParam:"style=form,explode=true,name=include"`
	// Current page.
...
func (o *ListWafTagsRequest) GetInclude() *string {
	return types.String("waf_rules")
}
