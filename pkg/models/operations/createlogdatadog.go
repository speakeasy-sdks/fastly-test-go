...
type CreateLogDatadogRequest struct {
	LoggingDatadog *shared.LoggingDatadog `request:"mediaType=application/x-www-form-urlencoded"`
...
func (o *CreateLogDatadogRequest) GetLoggingDatadog() *shared.LoggingDatadog {
	if o == nil {
		return nil
	}
