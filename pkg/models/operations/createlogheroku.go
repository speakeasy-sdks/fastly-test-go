...
type CreateLogHerokuRequest struct {
	LoggingHeroku *shared.LoggingHeroku `request:"mediaType=application/x-www-form-urlencoded"`
...
func (o *CreateLogHerokuRequest) GetLoggingHeroku() *shared.LoggingHeroku {
	if o == nil {
		return nil
	}
