...
type LoggingDigitaloceanResponse struct {
	...
	//
	FormatVersion *LoggingDigitaloceanResponseFormatVersion `json:"format_version,omitempty"`
	// The level of gzip encoding when sending logs (default `0`, no compression). Specifying both `compression_codec` and `gzip_level` in the same API request will result in an error.
	GzipLevel *int64 `json:"gzip_level,omitempty"`
	// How the message should be formatted.
	MessageType *LoggingDigitaloceanResponseMessageType `json:"message_type,omitempty"`
