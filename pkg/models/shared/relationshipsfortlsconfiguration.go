...
type RelationshipsForTLSConfiguration2DNSRecords struct {
	Data []RelationshipMemberTLSDNSRecord `json:"data,omitempty"`
}

func (o *RelationshipsForTLSConfiguration2DNSRecords) GetData() []RelationshipMemberTLSDNSRecord {
	if o == nil {
		return nil
	}
	return o.Data
...
type RelationshipsForTLSConfiguration2 struct {
	DNSRecords *RelationshipsForTLSConfiguration2DNSRecords `json:"dns_records,omitempty"`
}

func (o *RelationshipsForTLSConfiguration2) GetDNSRecords() *RelationshipsForTLSConfiguration2DNSRecords {
	if o == nil {
		return nil
	}
	return o.DNSRecords
...
func (u *RelationshipsForTLSConfiguration) UnmarshalJSON(data []byte) error {
	...
	relationshipsForTLSConfiguration1 := new(RelationshipsForTLSConfiguration1)
	...
	relationshipsForTLSConfiguration2 := new(RelationshipsForTLSConfiguration2)
