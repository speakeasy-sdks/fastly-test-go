...
type TLSBulkCertificateResponseData struct {
	...
	Relationships *RelationshipTLSConfigurations        `json:"relationships,omitempty"`
	// Resource type
...
func (o *TLSBulkCertificateResponseData) GetRelationships() *RelationshipTLSConfigurations {
	if o == nil {
		return nil
	}
