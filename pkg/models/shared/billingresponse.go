...
type BillingResponseRegions1 struct {
	AdditionalProperties map[string]BillingResponseRegions `additionalProperties:"true" json:"-"`
	Cost                 *float64                          `json:"cost,omitempty"`
}

func (b BillingResponseRegions1) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(b, "", false)
}

func (b *BillingResponseRegions1) UnmarshalJSON(data []byte) error {
...
func (o *BillingResponseRegions1) GetAdditionalProperties() map[string]BillingResponseRegions {
	if o == nil {
		return nil
	}
...
func (o *BillingResponseRegions1) GetCost() *float64 {
	if o == nil {
		return nil
	}
	return o.Cost
...
type BillingResponse struct {
	...
	Regions map[string]BillingResponseRegions1 `json:"regions,omitempty"`
	// Date and time in ISO 8601 format.
...
func (o *BillingResponse) GetRegions() map[string]BillingResponseRegions1 {
	if o == nil {
		return nil
	}
	return o.Regions
