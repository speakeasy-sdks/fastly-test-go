...
type MutualAuthenticationResponseData struct {
	...
	Relationships *RelationshipTLSActivations             `json:"relationships,omitempty"`
	// Resource type
...
func (o *MutualAuthenticationResponseData) GetRelationships() *RelationshipTLSActivations {
	if o == nil {
		return nil
	}
