...
const (
	JSONFormatZero JSONFormat = "0"
	JSONFormatOne  JSONFormat = "1"
	JSONFormatTwo  JSONFormat = "2"
)

func (e JSONFormat) ToPointer() *JSONFormat {
	return &e
}

func (e *JSONFormat) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "2":
		*e = JSONFormat(v)
		return nil
	default:
		return fmt.Errorf("invalid value for JSONFormat: %v", v)
	}
}
...
type LoggingHTTPS struct {
	...
	JSONFormat *JSONFormat `form:"name=json_format"`
	// How the message should be formatted.
	MessageType *LoggingMessageType `default:"classic" form:"name=message_type"`
	// HTTP method used for request.
	Method *Method `default:"POST" form:"name=method"`
...
func (o *LoggingHTTPS) GetJSONFormat() *JSONFormat {
	if o == nil {
		return nil
	}
	return o.JSONFormat
...
func (o *LoggingHTTPS) GetMethod() *Method {
	if o == nil {
		return nil
	}
	return o.Method
