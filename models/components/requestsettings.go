...
const (
	XffClear     Xff = "clear"
	XffLeave     Xff = "leave"
	XffAppend    Xff = "append"
	XffAppendAll Xff = "append_all"
	XffOverwrite Xff = "overwrite"
)

func (e Xff) ToPointer() *Xff {
	return &e
}

func (e *Xff) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "overwrite":
		*e = Xff(v)
		return nil
	default:
		return fmt.Errorf("invalid value for Xff: %v", v)
	}
}
...
func (o *RequestSettings) GetXff() *Xff {
	if o == nil {
		return nil
	}
	return o.Xff
