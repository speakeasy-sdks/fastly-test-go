...
type LoggingHerokuResponse struct {
	...
	//
	FormatVersion *LoggingHerokuResponseFormatVersion `default:"2" json:"format_version"`
...
func (l LoggingHerokuResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(l, "", false)
}

func (l *LoggingHerokuResponse) UnmarshalJSON(data []byte) error {
