...
func (e UseTLS) ToPointer() *UseTLS {
	return &e
}

func (e *UseTLS) UnmarshalJSON(data []byte) error {
	var v int64
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case 1:
		*e = UseTLS(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UseTLS: %v", v)
	}
}
...
type Pool struct {
	...
	// Whether to use TLS.
	UseTLS *UseTLS `default:"0" form:"name=use_tls"`
}
...
func (o *Pool) GetConnectTimeout() *int64 {
	if o == nil {
		return nil
	}
...
func (o *Pool) GetFirstByteTimeout() *int64 {
	if o == nil {
		return nil
	}
...
func (o *Pool) GetMaxConnDefault() *int64 {
	if o == nil {
		return nil
	}
...
func (o *Pool) GetMaxTLSVersion() *int64 {
	if o == nil {
		return nil
	}
...
func (o *Pool) GetMinTLSVersion() *int64 {
	if o == nil {
		return nil
	}
...
func (o *Pool) GetTLSCheckCert() *int64 {
	if o == nil {
		return nil
	}
