...
func (l LoggingHoneycomb) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(l, "", false)
}

func (l *LoggingHoneycomb) UnmarshalJSON(data []byte) error {
...
func (o *LoggingHoneycomb) GetFormatVersion() *LoggingHoneycombFormatVersion {
	if o == nil {
		return nil
	}
...
func (o *LoggingHoneycomb) GetPlacement() *LoggingHoneycombPlacement {
	if o == nil {
		return nil
	}
	return o.Placement
