...
func (o *CreateLogSumologicRequest) GetLoggingSumologic() *components.LoggingSumologic {
	if o == nil {
		return nil
	}
...
func (o *CreateLogSumologicResponse) GetLoggingSumologicResponse() *components.LoggingSumologicResponse {
	if o == nil {
		return nil
	}
