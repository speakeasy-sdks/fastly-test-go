...
type CreateLogLogentriesRequest struct {
	LoggingLogentries *components.LoggingLogentries `request:"mediaType=application/x-www-form-urlencoded"`
...
func (o *CreateLogLogentriesRequest) GetLoggingLogentries() *components.LoggingLogentries {
	if o == nil {
		return nil
	}
...
func (o *CreateLogLogentriesResponse) GetLoggingLogentriesResponse() *components.LoggingLogentriesResponse {
	if o == nil {
		return nil
	}
