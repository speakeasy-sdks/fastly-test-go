...
func (o *CreateLogElasticsearchRequest) GetLoggingElasticsearch() *components.LoggingElasticsearch {
	if o == nil {
		return nil
	}
...
func (o *CreateLogElasticsearchResponse) GetLoggingElasticsearchResponse() *components.LoggingElasticsearchResponse {
	if o == nil {
		return nil
	}
