...
// DeleteLogCloudfilesResponseBody - OK
type DeleteLogCloudfilesResponseBody struct {
	// ok
	Status *string `json:"status,omitempty"`
}

func (o *DeleteLogCloudfilesResponseBody) GetStatus() *string {
	if o == nil {
		return nil
	}
	return o.Status
...
func (o *DeleteLogCloudfilesResponse) GetObject() *DeleteLogCloudfilesResponseBody {
	if o == nil {
		return nil
	}
	return o.Object
