...
func (o *CreateLogDigoceanRequest) GetLoggingDigitalocean() *components.LoggingDigitalocean {
	if o == nil {
		return nil
	}
...
func (o *CreateLogDigoceanResponse) GetLoggingDigitaloceanResponse() *components.LoggingDigitaloceanResponse {
	if o == nil {
		return nil
	}
