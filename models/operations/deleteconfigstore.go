...
// DeleteConfigStoreResponseBody - OK
type DeleteConfigStoreResponseBody struct {
	// ok
	Status *string `json:"status,omitempty"`
}

func (o *DeleteConfigStoreResponseBody) GetStatus() *string {
	if o == nil {
		return nil
	}
	return o.Status
...
func (o *DeleteConfigStoreResponse) GetObject() *DeleteConfigStoreResponseBody {
	if o == nil {
		return nil
	}
	return o.Object
