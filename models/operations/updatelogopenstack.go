...
func (o *UpdateLogOpenstackRequest) GetLoggingOpenstack() *components.LoggingOpenstack {
	if o == nil {
		return nil
	}
...
func (o *UpdateLogOpenstackResponse) GetLoggingOpenstackResponse() *components.LoggingOpenstackResponse {
	if o == nil {
		return nil
	}
