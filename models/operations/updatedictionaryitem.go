...
func (o *UpdateDictionaryItemRequest) GetDictionaryItem() *components.DictionaryItem {
	if o == nil {
		return nil
	}
...
func (o *UpdateDictionaryItemResponse) GetDictionaryItemResponse() *components.DictionaryItemResponse {
	if o == nil {
		return nil
	}
