...
func (o *CreateLogLogglyRequest) GetLoggingLoggly() *components.LoggingLoggly {
	if o == nil {
		return nil
	}
...
func (o *CreateLogLogglyResponse) GetLoggingLogglyResponse() *components.LoggingLogglyResponse {
	if o == nil {
		return nil
	}
