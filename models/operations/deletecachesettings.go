...
// DeleteCacheSettingsResponseBody - OK
type DeleteCacheSettingsResponseBody struct {
	// ok
	Status *string `json:"status,omitempty"`
}

func (o *DeleteCacheSettingsResponseBody) GetStatus() *string {
	if o == nil {
		return nil
	}
	return o.Status
...
func (o *DeleteCacheSettingsResponse) GetObject() *DeleteCacheSettingsResponseBody {
	if o == nil {
		return nil
	}
	return o.Object
