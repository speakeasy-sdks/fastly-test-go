...
func (o *UpdateLogBigqueryRequest) GetLoggingBigquery() *components.LoggingBigquery {
	if o == nil {
		return nil
	}
...
func (o *UpdateLogBigqueryResponse) GetLoggingBigqueryResponse() *components.LoggingBigqueryResponse {
	if o == nil {
		return nil
	}
