...
// DeleteCustomVclResponseBody - OK
type DeleteCustomVclResponseBody struct {
	// ok
	Status *string `json:"status,omitempty"`
}

func (o *DeleteCustomVclResponseBody) GetStatus() *string {
	if o == nil {
		return nil
	}
	return o.Status
...
func (o *DeleteCustomVclResponse) GetObject() *DeleteCustomVclResponseBody {
	if o == nil {
		return nil
	}
	return o.Object
