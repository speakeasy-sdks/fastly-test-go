...
// DeleteLogBigqueryResponseBody - OK
type DeleteLogBigqueryResponseBody struct {
	// ok
	Status *string `json:"status,omitempty"`
}

func (o *DeleteLogBigqueryResponseBody) GetStatus() *string {
	if o == nil {
		return nil
	}
	return o.Status
...
func (o *DeleteLogBigqueryResponse) GetObject() *DeleteLogBigqueryResponseBody {
	if o == nil {
		return nil
	}
	return o.Object
