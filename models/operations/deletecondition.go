...
// DeleteConditionResponseBody - OK
type DeleteConditionResponseBody struct {
	// ok
	Status *string `json:"status,omitempty"`
}

func (o *DeleteConditionResponseBody) GetStatus() *string {
	if o == nil {
		return nil
	}
	return o.Status
...
func (o *DeleteConditionResponse) GetObject() *DeleteConditionResponseBody {
	if o == nil {
		return nil
	}
	return o.Object
