...
type UpdateServiceRequest struct {
	Service *components.Service `request:"mediaType=application/x-www-form-urlencoded"`
	// Alphanumeric string identifying the service.
	ServiceID string `pathParam:"style=simple,explode=false,name=service_id"`
}

func (o *UpdateServiceRequest) GetService() *components.Service {
	if o == nil {
		return nil
	}
	return o.Service
...
func (o *UpdateServiceResponse) GetServiceResponse() *components.ServiceResponse {
	if o == nil {
		return nil
	}
