...
func (o *UpdateLogLogentriesRequest) GetLoggingLogentries() *components.LoggingLogentries {
	if o == nil {
		return nil
	}
...
func (o *UpdateLogLogentriesResponse) GetLoggingLogentriesResponse() *components.LoggingLogentriesResponse {
	if o == nil {
		return nil
	}
