...
// DeleteLogLogentriesResponseBody - OK
type DeleteLogLogentriesResponseBody struct {
	// ok
	Status *string `json:"status,omitempty"`
}

func (o *DeleteLogLogentriesResponseBody) GetStatus() *string {
	if o == nil {
		return nil
	}
	return o.Status
...
func (o *DeleteLogLogentriesResponse) GetObject() *DeleteLogLogentriesResponseBody {
	if o == nil {
		return nil
	}
	return o.Object
