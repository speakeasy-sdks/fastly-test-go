...
func (o *CreateLogScalyrRequest) GetLoggingScalyr() *components.LoggingScalyr {
	if o == nil {
		return nil
	}
...
func (o *CreateLogScalyrResponse) GetLoggingScalyrResponse() *components.LoggingScalyrResponse {
	if o == nil {
		return nil
	}
