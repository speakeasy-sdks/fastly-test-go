...
func (s *tlsPrivateKeys) CreateTLSKey(ctx context.Context, request shared.TLSPrivateKeyInput, security operations.CreateTLSKeySecurity) (*operations.CreateTLSKeyResponse, error) {
...
func (s *tlsPrivateKeys) DeleteTLSKey(ctx context.Context, request operations.DeleteTLSKeyRequest, security operations.DeleteTLSKeySecurity) (*operations.DeleteTLSKeyResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
...
func (s *tlsPrivateKeys) GetTLSKey(ctx context.Context, request operations.GetTLSKeyRequest, security operations.GetTLSKeySecurity) (*operations.GetTLSKeyResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url, err := utils.GenerateURL(ctx, baseURL, "/tls/private_keys/{tls_private_key_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
...
func (s *tlsPrivateKeys) ListTLSKeys(ctx context.Context, request operations.ListTLSKeysRequest, security operations.ListTLSKeysSecurity) (*operations.ListTLSKeysResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url := strings.TrimSuffix(baseURL, "/") + "/tls/private_keys"
