...
func (s *loggingLoggly) CreateLogLoggly(ctx context.Context, request operations.CreateLogLogglyRequest) (*operations.CreateLogLogglyResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, true, "LoggingLoggly2", "form", `request:"mediaType=application/x-www-form-urlencoded"`)
	if err != nil {
