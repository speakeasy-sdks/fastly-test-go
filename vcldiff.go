...
func (s *VclDiff) VclDiffServiceVersions(ctx context.Context, request operations.VclDiffServiceVersionsRequest) (*operations.VclDiffServiceVersionsResponse, error) {
	hookCtx := hooks.HookContext{OperationID: "vcl-diff-service-versions"}

	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/service/{service_id}/vcl/diff/from/{from_version_id}/to/{to_version_id}", request, nil)
	if err != nil {
