...
func (s *content) ContentCheck(ctx context.Context, request operations.ContentCheckRequest, security operations.ContentCheckSecurity) (*operations.ContentCheckResponse, error) {
