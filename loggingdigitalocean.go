...
func (s *loggingDigitalocean) CreateLogDigocean(ctx context.Context, request operations.CreateLogDigoceanRequest, security operations.CreateLogDigoceanSecurity) (*operations.CreateLogDigoceanResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "LoggingDigitaloceanInput", "form")
	if err != nil {
...
func (s *loggingDigitalocean) DeleteLogDigocean(ctx context.Context, request operations.DeleteLogDigoceanRequest, security operations.DeleteLogDigoceanSecurity) (*operations.DeleteLogDigoceanResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
...
func (s *loggingDigitalocean) GetLogDigocean(ctx context.Context, request operations.GetLogDigoceanRequest, security operations.GetLogDigoceanSecurity) (*operations.GetLogDigoceanResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url, err := utils.GenerateURL(ctx, baseURL, "/service/{service_id}/version/{version_id}/logging/digitalocean/{logging_digitalocean_name}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
...
func (s *loggingDigitalocean) ListLogDigocean(ctx context.Context, request operations.ListLogDigoceanRequest, security operations.ListLogDigoceanSecurity) (*operations.ListLogDigoceanResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url, err := utils.GenerateURL(ctx, baseURL, "/service/{service_id}/version/{version_id}/logging/digitalocean", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
...
func (s *loggingDigitalocean) UpdateLogDigocean(ctx context.Context, request operations.UpdateLogDigoceanRequest, security operations.UpdateLogDigoceanSecurity) (*operations.UpdateLogDigoceanResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url, err := utils.GenerateURL(ctx, baseURL, "/service/{service_id}/version/{version_id}/logging/digitalocean/{logging_digitalocean_name}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
