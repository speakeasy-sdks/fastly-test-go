...
func (s *loggingPapertrail) CreateLogPapertrail(ctx context.Context, request operations.CreateLogPapertrailRequest) (*operations.CreateLogPapertrailResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, true, "LoggingPapertrail2", "form", `request:"mediaType=application/x-www-form-urlencoded"`)
	if err != nil {
