...
func (s *loggingHeroku) CreateLogHeroku(ctx context.Context, request operations.CreateLogHerokuRequest) (*operations.CreateLogHerokuResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, true, "LoggingHeroku2", "form", `request:"mediaType=application/x-www-form-urlencoded"`)
	if err != nil {
