...
func (s *rateLimiter) DeleteRateLimiter(ctx context.Context, request operations.DeleteRateLimiterRequest, security operations.DeleteRateLimiterSecurity) (*operations.DeleteRateLimiterResponse, error) {
...
func (s *rateLimiter) GetRateLimiter(ctx context.Context, request operations.GetRateLimiterRequest, security operations.GetRateLimiterSecurity) (*operations.GetRateLimiterResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url, err := utils.GenerateURL(ctx, baseURL, "/rate-limiters/{rate_limiter_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
...
func (s *rateLimiter) ListRateLimiters(ctx context.Context, request operations.ListRateLimitersRequest, security operations.ListRateLimitersSecurity) (*operations.ListRateLimitersResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
