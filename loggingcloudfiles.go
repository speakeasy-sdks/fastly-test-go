...
func (s *loggingCloudfiles) CreateLogCloudfiles(ctx context.Context, request operations.CreateLogCloudfilesRequest) (*operations.CreateLogCloudfilesResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, true, "LoggingCloudfilesInput", "form", `request:"mediaType=application/x-www-form-urlencoded"`)
	if err != nil {
