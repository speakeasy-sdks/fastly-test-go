...
func main() {
    ...
    res, err := s.Customer.UpdateCustomer(ctx, operations.UpdateCustomerRequest{
        CustomerInput: &shared.CustomerInput{
            BillingContactID: fastly.String("excepturi"),
            BillingNetworkType: shared.CustomerBillingNetworkTypePrivate.ToPointer(),
            BillingRef: fastly.String("modi"),
            ...
            IPWhitelist: fastly.String("praesentium"),
            LegalContactID: fastly.String("rem"),
            Name: fastly.String("Carl Waelchi DVM"),
            OwnerID: fastly.String("incidunt"),
            PhoneNumber: fastly.String("enim"),
            PostalAddress: fastly.String("consequatur"),
            PricingPlan: fastly.String("est"),
            PricingPlanID: fastly.String("quibusdam"),
            SecurityContactID: fastly.String("explicabo"),
            TechnicalContactID: fastly.String("deserunt"),
        },
        CustomerID: "x4xCwxxJxGCx123Rx5xTx",
    })
    if err != nil {
