...
func main() {
    ...
    res, err := s.Customer.UpdateCustomer(ctx, operations.UpdateCustomerRequest{
        CustomerInput: &shared.CustomerInput{
            ...
            IPWhitelist: sdk.String("pariatur"),
            LegalContactID: sdk.String("modi"),
            Name: sdk.String("Dr. Jordan Von"),
            OwnerID: sdk.String("veritatis"),
            PhoneNumber: sdk.String("itaque"),
            PostalAddress: sdk.String("incidunt"),
            PricingPlan: sdk.String("enim"),
            PricingPlanID: sdk.String("consequatur"),
            SecurityContactID: sdk.String("est"),
            TechnicalContactID: sdk.String("quibusdam"),
        },
        CustomerID: "x4xCwxxJxGCx123Rx5xTx",
    }, operationSecurity)
    if err != nil {
