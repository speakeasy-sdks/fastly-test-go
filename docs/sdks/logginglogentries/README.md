...
func main() {
    ...
    res, err := s.LoggingLogentries.CreateLogLogentries(ctx, operations.CreateLogLogentriesRequest{
        LoggingLogentries3: &shared.LoggingLogentries3{
            ...
            FormatVersion: shared.LoggingLogentriesFormatVersionOne.ToPointer(),
            Name: fastly.String("test-log-endpoint"),
            Placement: shared.LoggingLogentriesPlacementLessThanNilGreaterThan.ToPointer(),
            Port: fastly.Int64(359271),
            Region: shared.LoggingLogentriesRegionUs3.ToPointer(),
            ResponseCondition: fastly.String("null"),
            Token: fastly.String("aliquid"),
...
func main() {
    ...
    res, err := s.LoggingLogentries.UpdateLogLogentries(ctx, operations.UpdateLogLogentriesRequest{
        LoggingLogentries3: &shared.LoggingLogentries3{
            ...
            Port: fastly.Int64(775220),
            Region: shared.LoggingLogentriesRegionUs2.ToPointer(),
            ResponseCondition: fastly.String("null"),
            Token: fastly.String("recusandae"),
            UseTLS: shared.LoggingUseTLSZero.ToPointer(),
        },
        LoggingLogentriesName: "test-log-endpoint",
        ServiceID: "SU1Z0isxPaozGVKXdv0eY",
