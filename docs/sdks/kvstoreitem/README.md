...
func main() {
    ...
    res, err := s.KvStoreItem.GetKeys(ctx, operations.GetKeysRequest{
        Cursor: fastly.String("facilis"),
        Limit: fastly.Int64(596656),
        Prefix: fastly.String("voluptatem"),
        StoreID: "porro",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.KvStoreItem.SetValueForKey(ctx, operations.SetValueForKeyRequest{
        RequestBody: fastly.String("error"),
        Add: fastly.Bool(false),
        Append: fastly.Bool(false),
        BackgroundFetch: fastly.Bool(false),
        IfGenerationMatch: fastly.Int64(50370),
        KeyName: "occaecati",
        Metadata: fastly.String("rerum"),
        Prepend: fastly.Bool(false),
        StoreID: "adipisci",
        TimeToLiveSec: fastly.Int64(992397),
    })
    if err != nil {
        log.Fatal(err)
    }
