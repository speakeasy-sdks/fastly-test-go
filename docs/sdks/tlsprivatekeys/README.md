...
func main() {
    ...
    res, err := s.TLSPrivateKeys.CreateTLSKey(ctx, shared.TLSPrivateKey{
        Data: &shared.TLSPrivateKeyData{
            Attributes: &shared.TLSPrivateKeyDataAttributes{
                Key: fastly.String("<key>"),
                Name: fastly.String("white pascal Central"),
            },
            Relationships: &shared.RelationshipsForTLSPrivateKeyInput{},
            Type: fastly.String("payment"),
        },
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.TLSPrivateKeys.ListTLSKeys(ctx, operations.ListTLSKeysRequest{
        FilterInUse: fastly.String("Customer bypass"),
