...
func main() {
    ...
    res, err := s.RequestSettings.UpdateRequestSettings(ctx, operations.UpdateRequestSettingsRequest{
        RequestSettings: &shared.RequestSettings{
            ...
            BypassBusyWait: fastly.Int64(713589),
            DefaultHost: fastly.String("Northeast Producer"),
            ForceMiss: fastly.Int64(216239),
            ForceSsl: fastly.Int64(459715),
            GeoHeaders: fastly.Int64(703251),
            HashKeys: fastly.String("demanding niches"),
            MaxStaleAge: fastly.Int64(618939),
            Name: fastly.String("test-request-setting"),
            RequestCondition: fastly.String("null"),
            TimerSupport: fastly.Int64(698909),
            Xff: shared.RequestSettingsXffAppendAll.ToPointer(),
        },
        RequestSettingsName: "test-request-setting",
        ServiceID: "SU1Z0isxPaozGVKXdv0eY",
        VersionID: 1,
