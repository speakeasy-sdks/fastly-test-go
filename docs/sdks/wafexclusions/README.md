    ...
    res, err := s.WafExclusions.CreateWafRuleExclusion(ctx, operations.CreateWafRuleExclusionRequest{
        ...
        WafExclusion: &shared.WafExclusion{
            Data: &shared.WafExclusionData{
                ...
                Relationships: shared.CreateRelationshipsForWafExclusionInputRelationshipWafRuleRevisionsInput(
                        shared.RelationshipWafRuleRevisionsInput{
    ...
    res, err := s.WafExclusions.UpdateWafRuleExclusion(ctx, operations.UpdateWafRuleExclusionRequest{
        ...
        WafExclusion: &shared.WafExclusion{
            Data: &shared.WafExclusionData{
                ...
                Relationships: shared.CreateRelationshipsForWafExclusionInputRelationshipWafRulesInput(
                        shared.RelationshipWafRulesInput{
