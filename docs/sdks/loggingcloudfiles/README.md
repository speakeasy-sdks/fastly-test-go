...
func main() {
    ...
    res, err := s.LoggingCloudfiles.CreateLogCloudfiles(ctx, operations.CreateLogCloudfilesRequest{
        LoggingCloudfilesInput: &shared.LoggingCloudfilesInput{
            AccessKey: fastly.String("Gasoline Technician North"),
            BucketName: fastly.String("Immanuel"),
            ...
            Path: fastly.String("/usr/include"),
        ...
        "),
            ...
            User: fastly.String("Foster_Hettinger"),
        },
...
func main() {
    ...
    res, err := s.LoggingCloudfiles.UpdateLogCloudfiles(ctx, operations.UpdateLogCloudfilesRequest{
        LoggingCloudfilesInput: &shared.LoggingCloudfilesInput{
            AccessKey: fastly.String("calculating capacitor Bicycle"),
            BucketName: fastly.String("interactive"),
        ...
        -----END PRIVATE KEY-----
        "),
            Region: shared.LoggingCloudfilesRegionDfw.ToPointer(),
            ResponseCondition: fastly.String("null"),
            User: fastly.String("Casper.Stanton"),
        },
        LoggingCloudfilesName: "test-log-endpoint",
        ServiceID: "SU1Z0isxPaozGVKXdv0eY",
        VersionID: 1,
