...
func main() {
    ...
    res, err := s.WafRules.ListWafRules(ctx, operations.ListWafRulesRequest{
        FilterModsecRuleID: fastly.String("South pricing"),
        FilterWafFirewallIDNotMatch: fastly.String("Hatchback Avon"),
        FilterWafRuleRevisionsSource: fastly.String("Latin candela Home"),
        FilterWafTagsName: fastly.String("Electric Tajikistan"),
        Include: fastly.String("waf_tags,waf_rule_revisions"),
