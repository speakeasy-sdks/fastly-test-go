...
func main() {
    ...
    res, err := s.LoggingKafka.CreateLogKafka(ctx, operations.CreateLogKafkaRequest{
        LoggingKafka: &shared.LoggingKafka{
            AuthMethod: shared.LoggingKafkaAuthMethodPlain.ToPointer(),
            Brokers: fastly.String("regarding Hills dynamic"),
            ...
            Password: fastly.String("pYCQxRtGcFHbQQe"),
            Placement: shared.LoggingKafkaPlacementLessThanNilGreaterThan.ToPointer(),
            RequestMaxBytes: fastly.Int64(849155),
            RequiredAcks: shared.LoggingKafkaRequiredAcksOne.ToPointer(),
            ResponseCondition: fastly.String("null"),
            TLSCaCert: fastly.String("Avon"),
            TLSClientCert: fastly.String("ashamed Market"),
            TLSClientKey: fastly.String("Buckinghamshire Southwest feed"),
            TLSHostname: fastly.String("Ball"),
            Topic: fastly.String("mindshare"),
            UseTLS: shared.LoggingUseTLSOne.ToPointer(),
            User: fastly.String("Earline_Lynch83"),
        },
