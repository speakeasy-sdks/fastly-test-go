...
func main() {
    ...
    res, err := s.LoggingNewrelic.CreateLogNewrelic(ctx, operations.CreateLogNewrelicRequest{
        LoggingNewrelic: &shared.LoggingNewrelic{
            Format: fastly.String("copy Tigard"),
            ...
            Token: fastly.String("Sports plantation unless"),
        },
