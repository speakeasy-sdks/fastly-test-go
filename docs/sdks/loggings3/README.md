...
func main() {
    ...
    res, err := s.LoggingS3.CreateLogAwsS3(ctx, operations.CreateLogAwsS3Request{
        ...
        -----END PRIVATE KEY-----
        "),
            Redundancy: sdk.String("id"),
            ResponseCondition: sdk.String("null"),
            SecretKey: sdk.String("quidem"),
            ServerSideEncryption: sdk.String("neque"),
            ServerSideEncryptionKmsKeyID: sdk.String("quo"),
        },
...
func main() {
    ...
    res, err := s.LoggingS3.UpdateLogAwsS3(ctx, operations.UpdateLogAwsS3Request{
        ...
        -----END PRIVATE KEY-----
        "),
            Redundancy: sdk.String("tempora"),
            ResponseCondition: sdk.String("null"),
            SecretKey: sdk.String("debitis"),
            ServerSideEncryption: sdk.String("ipsam"),
            ServerSideEncryptionKmsKeyID: sdk.String("aspernatur"),
        },
        LoggingS3Name: "test-log-endpoint",
        ServiceID: "SU1Z0isxPaozGVKXdv0eY",
        VersionID: 1,
