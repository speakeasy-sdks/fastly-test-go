...
func main() {
    ...
    res, err := s.Gzip.CreateGzipConfig(ctx, operations.CreateGzipConfigRequest{
        Gzip: &shared.Gzip{
            ...
            ContentTypes: fastly.String("Automotive violet Analyst"),
            Extensions: fastly.String("Indiana beneath"),
...
func main() {
    ...
    res, err := s.Gzip.UpdateGzipConfig(ctx, operations.UpdateGzipConfigRequest{
        Gzip: &shared.Gzip{
            CacheCondition: fastly.String("null"),
            ContentTypes: fastly.String("proactive transition"),
            Extensions: fastly.String("Northeast"),
            Name: fastly.String("test-gzip"),
        },
        GzipName: "test-gzip",
        ServiceID: "SU1Z0isxPaozGVKXdv0eY",
