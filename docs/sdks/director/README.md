    ...
    res, err := s.Director.CreateDirector(ctx, operations.CreateDirectorRequest{
        Director: &shared.Director{
            Backends: []shared.Backend{
                shared.Backend{
                    Address: fastly.String("717 Shyann Court"),
                    AutoLoadbalance: fastly.Bool(false),
                    BetweenBytesTimeout: fastly.Int64(738047),
                    ClientCert: fastly.String("Trinidad Walter"),
                    Comment: fastly.String("New ABC 13 9370, 13.3, 5th Gen CoreA5-8250U, 8GB RAM, 256GB SSD, power UHD Graphics, OS 10 Home, OS Office A & J 2016"),
                    ConnectTimeout: fastly.Int64(170452),
                    FirstByteTimeout: fastly.Int64(352442),
                    Healthcheck: fastly.String("Ford alien"),
                    Hostname: fastly.String("fuzzy-agency.com"),
                    Ipv4: fastly.String("114.120.196.94"),
                    Ipv6: fastly.String("32b3:6d69:96eb:3917:b6f8:6c39:5e53:79ef"),
                    KeepaliveTime: fastly.Int64(252718),
                    MaxConn: fastly.Int64(42903),
                    MaxTLSVersion: fastly.String("Gorgeous"),
                    MinTLSVersion: fastly.String("Concrete Wagon Cambridgeshire"),
                    Name: fastly.String("test-backend"),
                    OverrideHost: fastly.String("Research vortals Applications"),
                    Port: fastly.Int64(173140),
                    RequestCondition: fastly.String("Books Hop"),
                    Shield: fastly.String("for Elta"),
                    SslCaCert: fastly.String("Gadolinium Inverse executor"),
                    SslCertHostname: fastly.String("ivory since benchmark"),
                    SslCheckCert: fastly.Bool(false),
                    SslCiphers: fastly.String("person Louisiana"),
                    SslClientCert: fastly.String("Macao Rubber architect"),
                    SslClientKey: fastly.String("Branding subdued Generic"),
                    SslHostname: fastly.String("if"),
                    SslSniHostname: fastly.String("Checking East Fresh"),
                    UseSsl: fastly.Bool(false),
                    Weight: fastly.Int64(299197),
                },
            },
            Capacity: fastly.Int64(835514),
            Comment: fastly.String("The Apollotech B340 is an affordable wireless mouse with reliable connectivity, 12 months battery life and modern design"),
            Name: fastly.String("test-director"),
            Quorum: fastly.Int64(124644),
            Retries: fastly.Int64(725220),
            Shield: fastly.String("Human trim Bicycle"),
            Type: shared.DirectorTypeOne.ToPointer(),
        },
