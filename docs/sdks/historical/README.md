...
func main() {
    ...
    res, err := s.Historical.GetHistStats(ctx, operations.GetHistStatsRequest{
        ...
        From: fastly.String("male"),
        Region: shared.RegionUsa.ToPointer(),
        To: fastly.String("azure Universal"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Historical.GetHistStatsAggregated(ctx, operations.GetHistStatsAggregatedRequest{
        By: shared.ByDay.ToPointer(),
        From: fastly.String("program"),
        Region: shared.RegionUsa.ToPointer(),
        To: fastly.String("lime"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Historical.GetHistStatsField(ctx, operations.GetHistStatsFieldRequest{
        By: shared.ByDay.ToPointer(),
        Field: "hit_ratio",
        From: fastly.String("bleakly siemens desktop"),
        Region: shared.RegionUsa.ToPointer(),
        To: fastly.String("Van drive"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Historical.GetHistStatsService(ctx, operations.GetHistStatsServiceRequest{
        By: shared.ByDay.ToPointer(),
        From: fastly.String("Gold Reduced sexy"),
        Region: shared.RegionUsa.ToPointer(),
        ServiceID: "SU1Z0isxPaozGVKXdv0eY",
        To: fastly.String("Advanced"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Historical.GetHistStatsServiceField(ctx, operations.GetHistStatsServiceFieldRequest{
        By: shared.ByDay.ToPointer(),
        Field: "hit_ratio",
        From: fastly.String("phew Micronesia overlooked"),
        Region: shared.RegionUsa.ToPointer(),
        ServiceID: "SU1Z0isxPaozGVKXdv0eY",
        To: fastly.String("Solutions Designer"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Historical.GetUsage(ctx, operations.GetUsageRequest{
        From: fastly.String("plum Visionary droopy"),
        To: fastly.String("lavender Estates Kentucky"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Historical.GetUsageService(ctx, operations.GetUsageServiceRequest{
        From: fastly.String("Southeast Facilitator Cab"),
        To: fastly.String("Savings Mercedes"),
    })
    if err != nil {
        log.Fatal(err)
    }
