...
func (s *aclEntry) BulkUpdateACLEntries(ctx context.Context, request operations.BulkUpdateACLEntriesRequest) (*operations.BulkUpdateACLEntriesResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, true, "BulkUpdateACLEntriesRequestInput", "json", `request:"mediaType=application/json"`)
	if err != nil {
